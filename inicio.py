...
def app_inicio():
	st.header("Objetivo")
	st.write("Innovar los servicios de consultoría a nivel nacional e internacional, ofreciendo a nuestros clientes servicios en consultoría, asesoría y capacitación basados en sistemas de información geográfica y programación")
	st.header("Misión")
	st.write("Brindar servicios de consultoría, así como asesoramiento en la implementación de sistemas de gestión integrados, asuntos regulatorios y capacitación profesional, que permitan el correcto desarrollo operacional, ambiental, legal, administrativo y financiero a las actividades, obras o proyectos Públicos, Privados o Mixtos.")
	st.header("Visión")
	st.write("Ser una empresa líder en la prestación de servicios de consultoría, sistemas de gestión integrados, asuntos regulatorios y capacitación profesional, reconocida nacional e internacionalmente por sus altos estándares de calidad en toda la gama de servicios ofertados.")
